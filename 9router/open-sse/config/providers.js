...
export const PROVIDERS = {
  ...
  gemini: {
    ...
    format: "gemini",
    clientId: process.env.GEMINI_OAUTH_CLIENT_ID || "REDACTED_GEMINI_CLIENT_ID",
    clientSecret: process.env.GEMINI_OAUTH_CLIENT_SECRET || "REDACTED_GEMINI_CLIENT_SECRET"
  },
  "gemini-cli": {
    baseUrl: "https://cloudcode-pa.googleapis.com/v1internal",
    format: "gemini-cli",
    clientId: process.env.GEMINI_CLI_OAUTH_CLIENT_ID || "REDACTED_GEMINI_CLI_CLIENT_ID",
    clientSecret: process.env.GEMINI_CLI_OAUTH_CLIENT_SECRET || "REDACTED_GEMINI_CLI_CLIENT_SECRET"
  },
  codex: {
    ...
    clientSecret: process.env.CODEX_OAUTH_CLIENT_SECRET || "REDACTED_CODEX_CLIENT_SECRET",
  ...
  iflow: {
    ...
    clientSecret: process.env.IFLOW_OAUTH_CLIENT_SECRET || "REDACTED_IFLOW_CLIENT_SECRET",
  ...
  qoder: {
    ...
    clientId: process.env.QODER_OAUTH_CLIENT_ID || "REDACTED_QODER_CLIENT_ID",
    clientSecret: process.env.QODER_OAUTH_CLIENT_SECRET || "REDACTED_QODER_CLIENT_SECRET",
  ...
  antigravity: {
    ...
    clientId: process.env.ANTIGRAVITY_OAUTH_CLIENT_ID || "REDACTED_ANTIGRAVITY_CLIENT_ID",
    clientSecret: process.env.ANTIGRAVITY_OAUTH_CLIENT_SECRET || "REDACTED_ANTIGRAVITY_CLIENT_SECRET"
  },
  openrouter: {
